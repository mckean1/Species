    ...
    public SocialTraditionCatalog()
    {
        var definitions = new[]
        {
            new SocialTraditionDefinition
            {
                ...
                IdentityChangeTemplate = "{0} developed enduring storage customs after repeated hardship."
            },
            new SocialTraditionDefinition
            {
                Id = SeasonalReturnId,
                ...
                IdentityChangeTemplate = "Seasonal return patterns became part of {0}'s identity."
            },
            new SocialTraditionDefinition
            {
                ...
                IdentityChangeTemplate = "Frontier regions of {0} developed stronger autonomy expectations."
            },
            new SocialTraditionDefinition
            {
                ...
                IdentityChangeTemplate = "The heartland of {0} hardened into a rooted social core."
            },
            new SocialTraditionDefinition
            {
                ...
                IdentityChangeTemplate = "Repeated coordination pushed {0} toward a stronger order tradition."
            }
        };
