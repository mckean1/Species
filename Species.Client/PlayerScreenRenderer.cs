...
public static class PlayerScreenRenderer
{
        ...
        TerminalViewport viewport)
    {
        return viewState.CurrentScreen switch
        {
            ...
            PlayerScreen.Regions => RegionViewerRenderer.Render(world, viewState.FocalGroupId, viewState.CurrentRegionIndex, floraCatalog, faunaCatalog, discoveryCatalog, advancementCatalog, viewport),
